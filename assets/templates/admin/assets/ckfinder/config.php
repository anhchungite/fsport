...
*/
$baseUrl = base_url().FOLDER_UPLOAD;
...
include_once "./assets/templates/admin/assets/ckfinder/plugins/imageresize/plugin.php";
include_once "./assets/templates/admin/assets/ckfinder/plugins/fileeditor/plugin.php";
include_once "./assets/templates/admin/assets/ckfinder/plugins/zip/plugin.php";
