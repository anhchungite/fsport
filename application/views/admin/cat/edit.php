					...
					<div class="alert alert-success fade in">
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                           <?php if(isset($arr_cat)) {

                               $id = $arr_cat['categoryID'];
                               $name = $arr_cat['categoryName'];
                               $img = $arr_cat['categoryImage'];
                               $des = $arr_cat['categoryDescription'];
                               $sort = $arr_cat['categorySortOrder'];
                               $parentID = $arr_cat['parentCategoryID'];
                               ?>
                               <div class="form">
                                   <form class="form-validate form-horizontal" id="cat_form" method="post" action="">
                                       <div class="form-group">
                                           <label class="control-label col-lg-2">Tên <span
                                       ...
                                       <div class="form-group">
                                           <label class="control-label col-lg-2">Hình ảnh <span
                                                   class="required">*</span></label>
                                           <div class="col-lg-6">
                                                   <?php echo form_error('image') ?>
                                               <div class="btn btn-default pull-left" style="margin-right: 5px;"
                                                    onclick="BrowseServer()">Duyệt...
                                               </div>
                                               <span class="pull-left" style="width: 85%"><input class="form-control"
                                                                                                 id="link_logo"
                                                                                                 name="image"
                                                                                                 type="text" value="<?php echo set_value('image', $img)?>"/>
                                          <div class="logo-prev" style="margin-top:5px"><img class="img-thumbnail"
                                                                                             alt=""
                                                                                             src="<?php echo $img ?>"
                                                                                             width="100px"></div>
                                          </span>
                                       ...
                                       <div class="form-group ">
                                           ...
                                           <div class="col-lg-10">
                                               ...
                                               <textarea class="form-control" name="des"
                                                         rows="2"><?php echo set_value('des', $des) ?></textarea>
                                           </div>
                                       </div>
                                       <div class="form-group">
                                           ...
                                           <div class="col-lg-3">
                                               <select class="form-control m-bot15" name="parent">
                                                   ...
                                                   <?php if (isset($arr_all_cat)) {
                                                       function show_cat($arr_all_cat,$parentID, $parent_id = 0, $char = "")
                                                       {
                                                           foreach ($arr_all_cat as $key => $value) {
                                                               if ($value['parentCategoryID'] == $parent_id) {
                                                                   ...
                                                                   ?>
                                                                   <option
                                                                       value="<?php echo $value['categoryID'] ?>" <?php echo set_value('parent', $parentID)==$value['categoryID']?"selected":""?>>
                                                                       <?php echo $arrow.$char . $value['categoryName'] ?></option>
                                                                   <?php
                                                                   unset($arr_all_cat[$key]);
                                                                   show_cat($arr_all_cat,$parentID, $value['categoryID'], $char . "|---");
                                                               }
                                                           }
                                                       }

                                                       show_cat($arr_all_cat, $parentID);
                                                   }
                                                   ?>
                                               </select>
                                           </div>
                                       ...
                                       <div class="form-group ">
                                           ...
                                           <div class="col-lg-5">
                                               <input type="number" min="1" max="100" value="<?php echo $sort ?>"
                                                      name="sort" required/>
                                           </div>
                                       </div>
                                       <div class="form-group">
                                           <div class="col-lg-offset-2 col-lg-10">
                                               <input class="btn btn-primary" type="submit" name="btn_save"
                                                      value="Lưu lại"/>
                                               <input class="btn btn-success" type="submit" name="btn_save_add"
                                                      value="Lưu & thêm"/>
