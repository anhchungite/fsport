<div class="row">
   <div class="col-lg-12">
      ...
      <div class="panel panel-default">
         ...
         <?php
 		 if(isset($arr_product)) {
            $ten = $arr_product['productName'];
            $thuonghieu = $arr_product['brandID'];
            $chitiet = $arr_product['productDetail'];
            $mota = $arr_product['productDescription'];
            $tukhoa = $arr_product['productKeyword'];
            $giagoc = $arr_product['productOriginalPrice'];
            $discount = $arr_product['productDiscount'];
            $giaban = $arr_product['productPrice'];
            $soluong = $arr_product['productQuantity'];
            $sapxep = $arr_product['productSort'];
            $trangthai = $arr_product['productStatus'];
            $arr_image = json_decode($arr_product['productImage']);
            $arr_color = json_decode($arr_product['productColor']);
            $arr_size = json_decode($arr_product['productSize']);
               ...
               <div class="tab-content">
                  <div class="tab-pane active" id="tab-general">
                     <div class="tab-content">
                        <div class="form-group">
                           ...
                           <div class="col-sm-10">
                              <input type="text" name="input_ten" value="<?php echo set_value('input_ten', $ten) ?>"
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-10">
                              <textarea name="input_chitiet" class="ckeditor"
                                        id="input_description"><?php echo set_value('input_chitiet', $chitiet) ?></textarea>
                              <!-- Tag input -->
                              <link rel="stylesheet"
                                    href="<?php echo TEMPLATES_ADMIN ?>/lib/tagsinput-bs/bootstrap-tagsinput.css">
                              <link rel="stylesheet"
                                    href="<?php echo TEMPLATES_ADMIN ?>/lib/tagsinput-bs/bootstrap-tagsinput-typeahead.css">
                              <div class="input-group" style="margin-top: 10px">
                                 <span class="input-group-addon">Tags:</span>
                                 <input name="input_tag" class="form-control tagsinput-typeahead" type="text"
                                        value="<?php echo set_value('input_tag', implode(',', $arr_tag_name)) ?>"/>
                              </div>
                           </div>
                           <script src="/assets/templates/admin/js/jquery-2.2.1.min.js"></script>
                           <script
                               src="<?php echo TEMPLATES_ADMIN . '/lib/tagsinput-bs/bootstrap-tagsinput.js' ?>"></script>
                           <script
                               src="<?php echo TEMPLATES_ADMIN . '/lib/tagsinput-bs/bootstrap3-typeahead.js' ?>"></script>
                           <script>
                              var places = [
                                 <?php
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-10">
                              <textarea name="input_mota" rows="3"
                                        ...
                                        class="form-control"><?php echo set_value('input_mota', $mota) ?></textarea>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-10">
                              <textarea name="input_tukhoa" rows="2" placeholder="Từ khóa:"
                                        id="input_meta-keyword2"
                                        class="form-control"><?php echo set_value('input_tukhoa', $tukhoa) ?></textarea>
                           </div>
                        </div>
                  ...
                  <div class="tab-pane" id="tab-data">
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <input type="number" name="input_giagoc" min="1000"
                                  value="<?php echo set_value('input_giagoc', $giagoc) ?>"
                                  placeholder="Giá gốc (>1000)" id="input_price"
                                  class="form-control">
                        </div>
                     </div>
                     <div class="form-group">
                        <label class="col-sm-2 control-label" for="input_price">Giảm giá
                           <span class="required">*</span>
                        </label>
                        <div class="col-sm-10">
                           <input type="number" name="input_giacu" min="1"
                                  value="<?php echo set_value('input_giacu', $discount) ?>"
                                  placeholder="%" id="input_price"
                                  class="form-control">
                        </div>
                     </div>
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <input type="number" name="input_giaban" min="1000"
                                  value="<?php echo set_value('input_giaban', $giaban) ?>"
                                  placeholder="VNĐ" id="input_price"
                                  class="form-control">
                        </div>
                     </div>
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <input type="number" name="input_soluong" min="1"
                                  value="<?php echo set_value('input_soluong', $soluong) ?>"
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <label class="radio-inline">
                              <input type="radio" name="input_trangthai"
                                     value="2" <?php echo set_value('input_trangthai', $trangthai) == 2 ? "checked" : "" ?>>
                              Bật
                           </label>
                           <label class="radio-inline">
                              <input type="radio" name="input_trangthai"
                                     value="1" <?php echo set_value('input_trangthai', $trangthai) == 1 ? "checked" : "" ?>>
                              Tắt
                           </label>
                           <label class="radio-inline">
                              <input type="radio" name="input_trangthai"
                                     value="0" <?php echo set_value('input_trangthai', $trangthai) == 0 ? "checked" : "" ?>>
                              Hết hàng
                           </label>
                        </div>
                     </div>
                     <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-sort-order">Thứ
                           tự:</label>
                        <div class="col-sm-10">
                           <input type="number" name="input_thutu"
                                  value="<?php echo set_value('input_thutu', $sapxep) ?>"
                  ...
                  <div class="tab-pane" id="tab-links">
                     <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-manufacturer"><span
                               data-toggle="tooltip" title="">Hãng sản xuất </span><span
                        ...
                        <div class="col-sm-10">
                           ...
                           <select name="input_nhanhieu" class="selectpicker show-tick"
                              ...
                              <?php if (isset($arr_all_brand)): foreach ($arr_all_brand as $value): ?>
                                 <option
                                     value="<?php echo $value['brandID'] ?>" <?php echo set_value('input_nhanhieu', $thuonghieu) == $value['brandID'] ? "selected" : "" ?>>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           ...
                           <select name="input_danhmuc[]" class="selectpicker" multiple data-actions-box="true"
                                   data-selected-text-format="count > 0" title="Chọn danh mục..."
                                   data-live-search="true">
                              <?php if (isset($arr_all_cat)) {
                                 //global $arr_cat_id;
                                 function show_cat($arr_all_cat, $arr_cat_id, $parent_id = 0, $char = "")
                                 {
                                    //global $arr_cat_id;
                                    foreach ($arr_all_cat as $key => $value) {
                                       if ($value['parentCategoryID'] == $parent_id) {
                                          ?>
                                          <option
                                              value="<?php echo $value['categoryID'] ?>" <?php if (set_value('input_danhmuc', $arr_cat_id)) {
                                             echo in_array($value['categoryID'], set_value('input_danhmuc', $arr_cat_id)) ? "selected" : "";
                                          } ?>><?php echo $char . $value['categoryName'] ?></option>

                                          <?php
                                          unset($arr_all_cat[$key]);
                                          show_cat($arr_all_cat, $arr_cat_id, $value['categoryID'], $char . "|---");
                                       }
                                    }
                                 }

                                 show_cat($arr_all_cat, $arr_cat_id);
                              }
                  ...
                  <div class="tab-pane" id="tab-attribute">
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <label class="radio-inline">
                              <input class="type-size" type="radio" name="input_type_size"
                                     value="1" <?php echo set_value('input_type_size', $arr_size[0]) == "1" ? "checked" : "" ?>>
                              Size chữ
                           </label>
                           <label class="radio-inline">
                              <input class="type-size" type="radio" name="input_type_size"
                                     value="0" <?php echo set_value('input_type_size', $arr_size[0]) == "0" ? "checked" : "" ?>>
                              Size số
                           </label>
                           <label class="radio-inline">
                              <input class="type-size" type="radio" name="input_type_size"
                                     value="2" <?php echo set_value('input_type_size', $arr_size[0]) == "2" ? "checked" : "" ?>>
                              Free size
                           </label>
                        </div>
                     </div>
                        ...
                        <div class="col-sm-10">
                           <select name="input_csize[]" class="selectpicker" multiple data-actions-box="true"
                              ...
                              <?php foreach ($arr_attr->schar as $value): ?>
                                 <option
                                     value="<?php echo trim($value) ?>" <?php if (set_value('input_csize', $arr_size)) {
                                    echo in_array($value, set_value('input_csize', $arr_size)) ? "selected" : "";
                        ...
                        <div class="col-sm-10">
                           <select name="input_nsize[]" class="selectpicker" multiple data-actions-box="true"
                              ...
                              <?php foreach ($arr_attr->snum as $value): ?>
                                 <option
                                     value="<?php echo trim($value) ?>" <?php if (set_value('input_nsize', $arr_size)) {
                                    echo in_array($value, set_value('input_nsize', $arr_size)) ? "selected" : "";
                                 } ?>><?php echo $value ?></option>
                              <?php endforeach; ?>
                           </select>
                        </div>
                        ...
                        <div class="col-sm-10">
                           <select name="input_mausac[]" class="selectpicker" multiple data-actions-box="true"
                              ...
                              <?php foreach ($arr_attr->color as $key => $value): ?>
                                 <option
                                     value="<?php echo trim($key) ?>" <?php if (set_value('input_mausac', $arr_color)) {
                                    echo in_array(trim($key), set_value('input_mausac', $arr_color)) ? "selected" : "";
                                 } ?>><?php echo $value ?></option>
                              <?php endforeach; ?>
                  ...
                  <div class="tab-pane" id="tab-image">
                     <div class="table-responsive">
                        <table id="images"
                           ...
                           <tr>
                              <td class="text-left">
                                 <div class="img-thumbnail" onclick="BrowseServer('input-img1')"
                              ...
                              <td class="text-right"><input type="text" id="input-img1"
                                                            name="input_image[]"
                                                            value="<?php echo set_value('input_image[]', $arr_image[0]) ?>"
                                                            class="form-control">
                              </td>
                           </tr>
                           </tbody>
                     ...
                     <div class="table-responsive">
                        <table id="images"
                           ...
                           <tr>
                              <td class="text-left">
                                 <div class="img-thumbnail" onclick="BrowseServer('input-img2')"
                                      style="cursor: pointer">
                                    <img src="<?php echo FILES_UPLOAD ?>/images/img-thumbnail-logo.png"
                                         alt="" title="Chọn hình ảnh">
                                 </div>
                              ...
                              <td class="text-right"><input type="text" id="input-img2"
                                                            name="input_image[]"
                                                            value="<?php echo set_value('input_image[]', $arr_image[1]) ?>"
                                                            class="form-control">
                              </td>
                           </tr>
                           <tr>
                              <td class="text-left">
                                 <div class="img-thumbnail" onclick="BrowseServer('input-img3')"
                                      style="cursor: pointer">
                                    <img src="<?php echo FILES_UPLOAD ?>/images/img-thumbnail-logo.png"
                                         alt="" title="Chọn hình ảnh">
                                 </div>
                              ...
                              <td class="text-right"><input type="text" id="input-img3"
                                                            name="input_image[]"
                                                            value="<?php echo set_value('input_image[]', $arr_image[2]) ?>"
                                                            class="form-control">
                              </td>
                           </tr>
                           <tr>
                              <td class="text-left">
                                 <div class="img-thumbnail" onclick="BrowseServer('input-img4')"
                                      style="cursor: pointer">
                                    <img src="<?php echo FILES_UPLOAD ?>/images/img-thumbnail-logo.png"
                                         alt="" title="Chọn hình ảnh">
                                 </div>
                              ...
                              <td class="text-right"><input type="text" id="input-img4"
                                                            name="input_image[]"
                                                            value="<?php echo set_value('input_image[]', $arr_image[3]) ?>"
                                                            class="form-control">
                              </td>
                           </tr>
                           </tbody>
